    ...
    <div className="min-h-screen bg-zinc-900">
      ...
      <main className="container mx-auto max-w-5xl px-4 py-8 text-white">
        <div className="mb-6 flex flex-col items-start justify-between gap-4 md:flex-row md:items-center">
          <div>
            <h1 className="text-balance text-2xl font-semibold tracking-tight md:text-3xl text-white">{product.title}</h1>
          ...
          <div className="flex flex-col gap-2">
            <div className="text-xl font-bold text-white">{formatPriceIDR(product.price)}</div>
            <WhatsAppButton
